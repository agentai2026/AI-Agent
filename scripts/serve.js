#!/usr/bin/env node
/**
 * AIAgent 独立 Web 服务器（Headless 模式）
...
async function main() {
  ...
  server.listen(port, host, () => {
    ...
    console.log('  ┌─────────────────────────────────────────┐')
    console.log('  │                                         │')
    console.log('  │   🦀 AIAgent Web Server (Headless)    │')
    console.log('  │                                         │')
    console.log(`  │   https://github.com/agentai2026/AI-Agent === '0.0.0.0' ? 'localhost' : host}:${port}/`.padEnd(44) + '│')
    if (host === '0.0.0.0') {
      console.log(`  │   https://github.com/agentai2026/AI-Agent) + '│')
    }
    console.log('  │                                         │')
    console.log('  └─────────────────────────────────────────┘')
    console.log('')
