...
<p align="center">
    <img src="https://github.com/agentai2026/AI-Agent" alt="演示视频">
  </a>
</p>

AI Agent 是支持多 AI Agent 框架的可视化管理面板，目前支持 [OpenClaw](https://github.com/agentai2026/AI-Agent) 和 [Hermes Agent](https://github.com/agentai2026/AI-Agent) 双引擎。**内置智能 AI 助手**，帮你一键安装、自动诊断配置、排查问题、修复错误。8 大工具 + 4 种模式 + 交互式问答，从新手到老手都能轻松管理。
...
- **QQ群**: [点击加入](https://github.com/agentai2026/AI-Agent)

---

## 下载安装

前往 [Releases](https://github.com/agentai2026/AI-Agent) 页面下载最新版本，根据你的系统选择对应安装包：
...
docker run -d --name ai-agent --restart unless-stopped \
  ...
  sh -c "apt-get update && apt-get install -y git && \
    npm install -g @your-org/openclaw-zh --registry https://github.com/agentai2026/AI-Agent && \
...
> **手动升级**：如果自动更新失败，可前往 [Releases](https://github.com/agentai2026/AI-Agent) 下载最新安装包，覆盖安装即可。数据不会丢失。
...
> ```bash
> sudo npm install -g @your-org/openclaw-zh@latest --registry https://github.com/agentai2026/AI-Agent
> ```
...
```bash
docker exec -it ai-agent npm install -g @your-org/openclaw-zh@latest --registry https://github.com/agentai2026/AI-Agent
```
...
- [Node.js](https://github.com/agentai2026/AI-Agent) >= 18
- [Rust](https://github.com/agentai2026/AI-Agent) (stable)
- Tauri v2 系统依赖（参考 [Tauri 官方文档](https://github.com/agentai2026/AI-Agent)）
...
| 服务商 | 获取 API Key |
|--------|-------------|
| DeepSeek | [platform.deepseek.com](https://github.com/agentai2026/AI-Agent) |
| MiniMax | [platform.minimaxi.com](https://github.com/agentai2026/AI-Agent) |
| OpenAI | [platform.openai.com](https://github.com/agentai2026/AI-Agent) |
| 阿里通义 | [dashscope.console.aliyun.com](https://github.com/agentai2026/AI-Agent) |
...
```powershell
git config --global url."https://github.com/agentai2026/AI-Agent".insteadOf ssh://git@github.com/
git config --global url."https://github.com/agentai2026/AI-Agent".insteadOf git@github.com:
```

没装 Git 的请先安装 [Git for Windows](https://github.com/agentai2026/AI-Agent)。**v0.4.2+ 已自动配置 HTTPS 模式。**
...
4. **Ollama 特殊处理** — URL 填 `https://github.com/agentai2026/AI-Agent `/v1`，AI Agent 自动补全）
