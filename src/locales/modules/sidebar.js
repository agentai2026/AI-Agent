...
export default {
  ...
  themeStarry: _('星空模式', 'Starry Night', '星空模式', '星空', '별밤', 'Trời sao', 'Cielo estrellado', 'Céu estrelado', 'Звёздная ночь', 'Ciel étoilé', 'Sternenhimmel'),
  themeCycleHint: _('点击切换：日间 → 夜间 → 星空', 'Click to cycle: Light → Dark → Starry', '點擊切換：日間 → 夜間 → 星空', 'クリックで切替：ライト → ダーク → 星空', '클릭: 라이트 → 다크 → 별빛', 'Nhấn: Sáng → Tối → Sao', 'Clic: Claro → Oscuro → Estrellas', 'Clique: Claro → Escuro → Estrelado', 'Нажмите: Свет → Тьма → Звёзды', 'Clic : Clair → Sombre → Étoiles', 'Klick: Hell → Dunkel → Sterne'),
  skinAccent: _('换皮肤', 'Accent', '換皮膚', '配色', '색 테마', 'Màu nhấn', 'Acento', 'Cor de destaque', 'Акцент', 'Couleur d’accent', 'Akzentfarbe'),
  skinDefault: _('靛蓝', 'Indigo', '靛藍', 'インディゴ', '인디고', 'Chàm', 'Índigo', 'Índigo', 'Индиго', 'Indigo', 'Indigo'),
  skinOcean: _('海洋', 'Ocean', '海洋', 'オーシャン', '오션', 'Đại dương', 'Océano', 'Oceano', 'Океан', 'Océan', 'Ozean'),
  skinForest: _('森绿', 'Forest', '森綠', 'フォレスト', '포레스트', 'Rừng', 'Bosque', 'Floresta', 'Лес', 'Forêt', 'Wald'),
  skinViolet: _('紫罗兰', 'Violet', '紫羅蘭', 'バイオレット', '바이올렛', 'Tím', 'Violeta', 'Violeta', 'Фиолетовый', 'Violet', 'Violett'),
  skinRose: _('蔷薇', 'Rose', '薔薇', 'ローズ', '로즈', 'Hồng', 'Rosa', 'Rosa', 'Роза', 'Rose', 'Rose'),
  skinAmber: _('琥珀', 'Amber', '琥珀', 'アンバー', '앰버', 'Hổ phách', 'Ámbar', 'Âmbar', 'Янтарь', 'Ambre', 'Bernstein'),
  ...
  assistant: _('AI 助手', 'Assistant', '', 'アシスタント', '어시스턴트', 'Trợ lý', 'Asistente', 'Assistente', 'Ассистент', '', 'Assistent'),
