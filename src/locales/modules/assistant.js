...
export default {
  ...
  apiBasePlaceholderOpenai: _('https://github.com/agentai2026/AI-Agent 或中转站地址', 'https://github.com/agentai2026/AI-Agent or proxy URL', 'https://github.com/agentai2026/AI-Agent 或中轉站位址'),
  apiKeyPlaceholderOpenai: _('sk-... 或中转站密钥', 'sk-... or proxy key', 'sk-... 或中轉站金鑰'),
  defaultName: _('AI 助手', 'Assistant', '', 'AI アシスタント', 'AI 어시스턴트', 'Trợ lý AI', 'Asistente IA', 'Assistente IA', 'ИИ-ассистент', 'Assistant IA', 'KI-Assistent'),
  ...
  skillCheckConfigDesc: _('检查 AI Agent 配置文件是否正确', 'Check if AI Agent config files are correct', '檢查 AI Agent 設定檔案是否正確'),
  ...
  skillBrowseDirDesc: _('浏览 AI Agent 配置目录结构', 'Browse AI Agent config directory structure', '瀏覽 AI Agent 設定目錄結構'),
  ...
  skillSkillsManagerDesc: _('管理 AI Agent 的 Skills', 'Manage AI Agent Skills'),
  // Hermes 专属 Skills
  ...
  fallbackBaseUrlPlaceholder: _('API Base URL，如 https://github.com/agentai2026/AI-Agent', 'API Base URL, e.g. https://github.com/agentai2026/AI-Agent', 'API Base URL，如 https://github.com/agentai2026/AI-Agent'),
  ...
  personaOpenClaw: _('AI Agent', 'AI Agent', 'AI Agent', 'AI Agent', 'AI Agent', 'AI Agent', 'AI Agent', 'AI Agent', 'AI Agent', 'AI Agent', 'AI Agent'),
  personaOpenClawHint: _('从 AI Agent 主程序继承身份与工作区设置', 'Inherit identity and workspace from AI Agent', '從 AI Agent 主程式繼承身份與工作區設定', 'AI Agent から ID とワークスペース設定を継承', 'AI Agent에서 ID 및 작업 공간 설정 상속', 'Kế thừa danh tính và workspace từ AI Agent', 'Heredar identidad y espacio de trabajo desde AI Agent', 'Herdar identidade e workspace do AI Agent', 'Наследовать идентичность и рабочую область от AI Agent', 'Hériter de l’identité et de l’espace de travail depuis AI Agent', 'Identität und Arbeitsbereich von AI Agent übernehmen'),
  ...
  importBtn: _('导入 AI Agent 配置', 'Import AI Agent Config', '导入 AI Agent 設定'),
  importScanning: _('正在扫描本地 AI Agent 配置...', 'Scanning local AI Agent config...', '正在掃描本地 AI Agent 設定...'),
  ...
  guideTitle: _('这是 AI Agent面板 内置的 AI 助手', 'This is AI Agent面板\'s built-in AI assistant', '这是 AI Agent面板 內置的 AI 助手'),
  guideDesc: _('，独立于 AI Agent，使用你在右上角「设置」中配置的 API。', ', independent of AI Agent, using the API configured in Settings.', '，獨立於 AI Agent，使用你在右上角「設定」中設定的 API。'),
  guideHint: _('如需与 AI Agent Agent 对话，请前往「实时聊天」页面。', 'To chat with AI Agent Agents, go to the Live Chat page.', '如需與 AI Agent Agent 對話，請前往「實時聊天」頁面。'),
  ...
  inputHint: _('Enter 发送 · Shift+Enter 换行 · 支持粘贴/拖拽图片 · AI 助手独立于 AI Agent', 'Enter to send · Shift+Enter for newline · Paste/drag images · Independent of AI Agent', 'Enter 發送 · Shift+Enter 換行 · 支援貼上/拖曳圖片 · AI 助手獨立於 AI Agent', 'Enter で送信 · Shift+Enter で改行 · 画像貼り付け/ドラッグ対応 · AI アシスタントは AI Agent とは独立'),
