...
export default {
  ...
  openclawReady: _('AI Agent 就绪', 'AI Agent Ready', 'AI Agent 就緒'),
  ...
  installCorrupt: _('AI Agent 安装可能已损坏', 'AI Agent installation may be corrupted', 'AI Agent 安裝可能已損壞'),
  installCorruptHint: _('检测到模块文件缺失，建议前往 <a href="#" data-nav="about" style="color:var(--primary);text-decoration:underline;font-weight:500">关于页面</a> 切换版本或重新安装 AI Agent CLI。', 'Module files missing. Go to <a href="#" data-nav="about" style="color:var(--primary);text-decoration:underline;font-weight:500">About page</a> to switch version or reinstall AI Agent CLI.', '檢測到模塊檔案缺失，建議前往 <a href="#" data-nav="about" style="color:var(--primary);text-decoration:underline;font-weight:500">關於頁面</a> 切換版本或重新安裝 AI Agent CLI。'),
  installCorruptToast: _('AI Agent 安装损坏，建议前往「关于」页重新安装', 'AI Agent installation corrupted, recommend reinstalling from About page', 'AI Agent 安裝損壞，建議前往「關於」頁重新安裝'),
  ...
  cliUnavailable: _('AI Agent CLI 不可用', 'AI Agent CLI unavailable'),
  cliUnavailableHint: _('请前往 <a href="#" data-nav="about" style="color:var(--primary);text-decoration:underline;font-weight:500">关于页面</a> 安装或重新安装 AI Agent。', 'Please go to <a href="#" data-nav="about" style="color:var(--primary);text-decoration:underline;font-weight:500">About page</a> to install or reinstall AI Agent.', '請前往 <a href="#" data-nav="about" style="color:var(--primary);text-decoration:underline;font-weight:500">關於頁面</a> 安裝或重新安裝 AI Agent。'),
  ...
  scanCliInstall: _('AI Agent 安装', 'AI Agent Installation', 'AI Agent 安裝', 'AI Agent インストール', 'AI Agent 설치', 'Cài đặt AI Agent', 'Instalación de AI Agent', 'Instalação do AI Agent', 'Установка AI Agent', 'Installation AI Agent', 'AI Agent-Installation'),
  scanCliMissing: _('未安装 AI Agent CLI', 'AI Agent CLI not installed', '未安裝 AI Agent CLI', 'AI Agent CLI 未インストール', 'AI Agent CLI 미설치', 'Chưa cài AI Agent CLI', 'AI Agent CLI no instalado', 'AI Agent CLI não instalado', 'AI Agent CLI не установлен', 'AI Agent CLI non installé', 'AI Agent CLI nicht installiert'),
