...
export default {
  ...
  desc: _('管理已安装的 Skills，或从社区搜索安装新技能', 'Manage installed Skills or search and install new ones from the community', '管理已安裝的 Skills，或從社區搜尋安裝新技能', 'AI Agent Skills の管理とインストール', 'AI Agent Skills 관리 및 설치', 'Quản lý và cài đặt AI Agent Skills', 'Gestionar e instalar AI Agent Skills', 'Gerenciar e instalar AI Agent Skills', 'Управление и установка навыков AI Agent', 'Gérer et installer les Skills AI Agent', 'AI Agent Skills verwalten und installieren'),
  ...
  loadFailedHint: _('请确认 AI Agent 已安装并可用', 'Please confirm AI Agent is installed and available', '請確認 AI Agent 已安裝並可用'),
  retry: _('重试', 'Retry', '重試'),
  ...
  noSkillsHint: _('请确认 AI Agent 已正确安装。Skills 随 AI Agent 捆绑提供；自定义 Skills 可能位于 <code>~/.openclaw/skills/</code> 或 <code>~/.claude/skills/</code>。', 'Please confirm AI Agent is properly installed. Skills are bundled with AI Agent; custom Skills may be in <code>~/.openclaw/skills/</code> or <code>~/.claude/skills/</code>.', '請確認 AI Agent 已正確安裝。Skills 隨 AI Agent 捆綁提供；自定義 Skills 可能位於 <code>~/.openclaw/skills/</code> 或 <code>~/.claude/skills/</code>。'),
