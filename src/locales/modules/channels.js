...
export default {
  ...
  qqbotGuide1: _('前往 <a href="https://q.qq.com" target="_blank" rel="noopener">QQ 开放平台</a> 创建机器人', 'Go to <a href="https://q.qq.com" target="_blank" rel="noopener">QQ Open Platform</a> to create a bot', '前往 <a href="https://q.qq.com" target="_blank" rel="noopener">QQ 開放平台</a> 建立機器人'),
  ...
  qqbotGuideFooter: _('<div style="margin-top:8px;font-size:var(--font-size-xs);color:var(--text-tertiary)">遇到问题？参考 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">AI Agent × QQ 常见问题</a></div>', '<div style="margin-top:8px;font-size:var(--font-size-xs);color:var(--text-tertiary)">Need help? See <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">AI Agent × QQ FAQ</a></div>', '<div style="margin-top:8px;font-size:var(--font-size-xs);color:var(--text-tertiary)">遇到問題？參考 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">AI Agent × QQ 常见問題</a></div>'),
  ...
  dingtalkGuide1: _('前往钉钉开放平台，创建「企业内部应用」', 'Go to DingTalk developer platform and create an internal enterprise app', '前往釘釘開放平台，建立「企業內部應用」'),
  ...
  feishuGuide1: _('前往 <a href="https://open.feishu.cn/app" target="_blank" rel="noopener">飞书开放平台</a> 创建企业自建应用', 'Go to <a href="https://open.feishu.cn/app" target="_blank" rel="noopener">Feishu Open Platform</a> to create a custom enterprise app', '前往 <a href="https://open.feishu.cn/app" target="_blank" rel="noopener">飛書開放平台</a> 建立企業自建應用'),
  ...
  telegramGuide1: _('在 Telegram 中搜索 @BotFather 并发送 <code>/newbot</code>', 'Search @BotFather in Telegram and send <code>/newbot</code>', '在 Telegram 中搜尋 @BotFather 並發送 <code>/newbot</code>'),
  ...
  discordGuide1: _('前往 Discord Developer Portal 创建 Application', 'Go to Discord Developer Portal and create an Application', '前往 Discord Developer Portal 建立 Application'),
  ...
  slackGuide1: _('前往 Slack API 创建 App（推荐 From a manifest）', 'Go to Slack API and create an App (recommended: From a manifest)', '前往 Slack API 建立 App（推薦 From a manifest）'),
  ...
  msteamsGuide1: _('在 Azure Portal 注册 Bot Channel Registration', 'Register Bot Channel Registration in Azure Portal', '在 Azure Portal 註冊 Bot Channel Registration'),
  ...
  signalGuide1: _('安装 signal-cli 并注册/链接账号', 'Install signal-cli and register/link your account', '安裝 signal-cli 並註冊/連結账號'),
  ...
  qqFaqBtn: _('打开 QQ AI Agent 常见问题', 'Open QQ AI Agent FAQ', '開啟 QQ AI Agent 常见問題'),
  ...
  qqDiagHint: _('检查<strong>已保存到配置文件</strong>的凭证、本机 Gateway 端口、<code>/__api/health</code>、QQ 插件与 chatCompletions。QQ 提示「灵魂不在线」时优先看此处，并参考 <a href="https://github.com/agentai2026/AI-Agent" target="_blank" rel="noopener">AI Agent × QQ 常见问题</a>。', '检查<strong>已保存到配置文件</strong>的凭证、本机 Gateway 端口、<code>/__api/health</code>、QQ 插件与 chatCompletions。QQ 提示「灵魂不在线」时优先看此处，并参考 <a href="https://github.com/agentai2026/AI-Agent" target="_blank" rel="noopener">AI Agent × QQ 常见问题</a>。', '檢查<strong>已儲存到設定檔案</strong>的憑證、本機 Gateway 連接埠、<code>/__api/health</code>、QQ 外掛與 chatCompletions。QQ 提示「靈魂不線上」時優先看此處，並參考 <a href="https://github.com/agentai2026/AI-Agent" target="_blank" rel="noopener">AI Agent × QQ 常见問題</a>。'),
  ...
  qqVerifyNote: _('此项只验证 AppID/Secret 能否向腾讯换 token。<strong>不能</strong>代表 QQ 里机器人已在线；若提示「灵魂不在线」，请使用下方 <strong>完整联通诊断</strong> 并对照 <a href="https://github.com/agentai2026/AI-Agent" target="_blank" rel="noopener">QQ AI Agent 常见问题</a>。', '此项只验证 AppID/Secret 能否向腾讯换 token。<strong>不能</strong>代表 QQ 里机器人已在线；若提示「灵魂不在线」，请使用下方 <strong>完整联通诊断</strong> 并对照 <a href="https://github.com/agentai2026/AI-Agent" target="_blank" rel="noopener">QQ AI Agent 常见问题</a>。', '此項只驗證 AppID/Secret 能否向腾訊換 token。<strong>不能</strong>代表 QQ 里機器人已線上；若提示「靈魂不線上」，請使用下方 <strong>完整聯通诊斷</strong> 並对照 <a href="https://github.com/agentai2026/AI-Agent" target="_blank" rel="noopener">QQ AI Agent 常见問題</a>。'),
