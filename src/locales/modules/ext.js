...
export default {
  ...
  desc: _('管理 cftunnel 内网穿透和移动客户端扩展', 'Manage cftunnel tunneling and the mobile client extension', '管理 cftunnel 內網穿透和移動用戶端擴充', 'cftunnel トンネリングとモバイルクライアント拡張の管理', 'cftunnel 터널링 및 모바일 클라이언트 확장 관리', 'Quản lý cftunnel và phần mở rộng mobile client', 'Gestionar cftunnel y la extensión del cliente móvil', 'Gerenciar cftunnel e a extensão do cliente móvel', 'Управление cftunnel и мобильным расширением', 'Gérer cftunnel et l’extension client mobile', 'cftunnel und mobile Client-Erweiterung verwalten'),
  ...
  clawappTitle: _('移动客户端', 'Mobile client', '移動用戶端', 'モバイルクライアント', '모바일 클라이언트', 'Mobile client', 'Cliente móvil', 'Cliente móvel', 'Мобильный клиент', 'Client mobile', 'Mobiler Client'),
  ...
  clawappNotInstalled: _('移动客户端未安装', 'Mobile client not installed', '移動用戶端未安裝', 'モバイルクライアント未インストール', '모바일 클라이언트 미설치'),
  ...
  openClawapp: _('打开移动客户端', 'Open mobile client', '開啟移動用戶端', 'モバイルクライアントを開く', '모바일 클라이언트 열기'),
