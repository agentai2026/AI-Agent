  ...
  try {
    ...
    banner.innerHTML = `
      <div class="update-banner-content">
        ...
        <a class="btn btn-sm" href="https://github.com/agentai2026/AI-Agent" target="_blank" rel="noopener">${t('about.downloadFromGitHub')}</a>
  ...
  try {
    ...
    if (app) app.innerHTML = `
      <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;padding:20px;text-align:center;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif">
        ...
        <div style="margin-top:24px;font-size:11px;color:#a1a1aa">${t('common.pageLoadFailedHint')}<br><a href="https://github.com/agentai2026/AI-Agent" target="_blank" style="color:#6366f1">GitHub Issues</a></div>
      </div>`
  }
  startUpdateChecker()
